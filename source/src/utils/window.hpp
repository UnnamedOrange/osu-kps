...
public:
    ...
    HWND create(HWND hwndParent = nullptr) {
        ...
        register_class();
        HWND ret =
            CreateWindowExW(0, get_class_name().c_str(), nullptr,
                            WS_POPUPWINDOW | WS_CAPTION | WS_MINIMIZEBOX | WS_MAXIMIZEBOX | WS_SIZEBOX | WS_VISIBLE, 50,
                            50, 380, 250, hwndParent, nullptr, GetModuleHandleW(nullptr), nullptr);
        if (!ret)
            semaphore_create.release();
        return ret;
    }
